...
static ProtocolLogManager * sSharedInstance;
@implementation ProtocolLogManager

+(id)sharedProtocolLogManager
{
    if(!sSharedInstance)
    {
        sSharedInstance = [[ProtocolLogManager alloc] init];
    }
...
{    
    ...
    {    
        ...
        NSEntityDescription *entity = [NSEntityDescription entityForName:kAccountInfo inManagedObjectContext:_managedObjectContext];
        [request setEntity:entity];
        
        // Order the events by creation date, most recent first.
        NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:kType ascending:YES];
...
{
    if (!(obj && [obj isKindOfClass:[AccountInfo class]])) {
        return;
    }
    //save to coredatas       
